...
.flexslider_2 .flex-direction-nav .flex-next:hover::before {
	top: 50%;
	left: 50%;
	margin: -8px 0 0 -24px;
	position: absolute;
...
.flexslider_2 .flex-direction-nav .flex-prev:hover::before {
    top: 50%;
    left: 50%;
    margin: -8px 0 0 -24px;
    position: absolute;
...
.flexslider_2 .slides li .imgMainbox {
	position: relative;
}

.flexslider_2 .slides li .imgMainbox img {
	width: 716px;
	max-width:100%;
}

.flexslider_2 .slides li .carousel-caption {
	padding-bottom: 0;
	bottom: 0;
	left: 0;
	padding-top: 0;
...
.flexslider_2 .carousel-caption .mTop {
top:-442px;
	height: 35px;
	color: #fff;
	text-align: left;
...
.flexslider_2 .carousel-caption .mTop a {
	display: inline-block;
}

.flexslider_2 .carousel-caption .mTop img {
	vertical-align: top;
}

.flexslider_2 .carousel-caption .mTop .wave1, .flexslider_2 .carousel-caption .mTop .wave2 {
	position: absolute;
	top: 1px;
	left: 8px;
	z-index: 1;
...
.flexslider_2 .carousel-caption .mCenter {
	position: absolute;
	top: 50%;
	left: 50%;
...
.flexslider_2 .carousel-caption .mBottom {
	position: absolute;
	bottom: 50px;
	left: 0;
	width: 100%;
...
.flexslider_2 .carousel-caption .mBottom em {
	color: #ffa800;
}

.flexslider_2 .carousel-caption .mFoot em {
	color: #ffa800;
}

.flexslider_2 .carousel-caption .mFoot {
	position: absolute;
	bottom: 0;
	left: 0;
	width: 100%;
...
.flexslider_2 .mTextend .box {
	margin-top: 12px;
	display: block;
	padding: 0 12px;
}

.flexslider_2 .mTextend .box .sty1 {
	font-size: 16px;
	color: #464646;
	display: inline-block;
...
.flexslider_2 .mTextend .box .sty2 {
	display: inline-block;
...
.flexslider_2 .mTextend .box .sty2 p {
	font-size: 14px;
	color: #828282;
	line-height: 24px;
	margin: 0;
